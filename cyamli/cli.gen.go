// Code generated by github.com/Jumpaku/cyamli v1.1.3, DO NOT EDIT.
package cyamli
...
func resolve_CLI_GenerateDart_Input(input *CLI_GenerateDart_Input, restArgs []string) error {
...
func Run(cli CLI, args []string) error {
	...
	case "generate dart":
		funcMethod := cli.Generate.Dart.FUNC
		if funcMethod == nil {
			return fmt.Errorf("%q is unsupported: cli.Generate.Dart.FUNC not assigned", "generate dart")
		}
		var input CLI_GenerateDart_Input
		err := resolve_CLI_GenerateDart_Input(&input, restArgs)
		return funcMethod(subcommandPath, input, err)
...
func resolveSubcommand(args []string) (subcommandPath []string, restArgs []string) {
	...
	subcommandSet := map[string]bool{
		"":         true,
		"generate": true, "generate dart": true, "generate docs": true, "generate golang": true, "generate python3": true, "list": true, "validate": true,
	}
