...
FuncType_CLI_Validate = typing.Callable[[None,list[str],CLI_Validate_Input,Exception],None]
class CLI_Validate:
    
    FUNC: FuncType_CLI_Validate = None
...
FuncType_CLI_GeneratePython3 = typing.Callable[[None,list[str],CLI_GeneratePython3_Input,Exception],None]
class CLI_GeneratePython3:
    
    FUNC: FuncType_CLI_GeneratePython3 = None
...
FuncType_CLI_GenerateGolang = typing.Callable[[None,list[str],CLI_GenerateGolang_Input,Exception],None]
class CLI_GenerateGolang:
    
    FUNC: FuncType_CLI_GenerateGolang = None
...
FuncType_CLI_GenerateDocs = typing.Callable[[None,list[str],CLI_GenerateDocs_Input,Exception],None]
class CLI_GenerateDocs:
    
    FUNC: FuncType_CLI_GenerateDocs = None
...
FuncType_CLI_GenerateDart = typing.Callable[[None,list[str],CLI_GenerateDart_Input,Exception],None]
class CLI_GenerateDart:
    
    FUNC: FuncType_CLI_GenerateDart = None
...
FuncType_CLI_Generate = typing.Callable[[None,list[str],CLI_Generate_Input,Exception],None]
class CLI_Generate:
    ...
    FUNC: FuncType_CLI_Generate = None
