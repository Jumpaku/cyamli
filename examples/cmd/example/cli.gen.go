...
func (CLI_Sub1) DESC_Simple() string {
	return "1 - this is a sub command\n\nUsage:\n    $ <program> sub1\n\n"
}
func (CLI_Sub1) DESC_Detail() string {
	return "1 - this is a sub command\n\nUsage:\n    $ <program> sub1\n\n"
}
...
func (CLI_Sub2) DESC_Simple() string {
	return "2 - this is a sub command\n\nUsage:\n    $ <program> sub2\n\n"
}
func (CLI_Sub2) DESC_Detail() string {
	return "2 - this is a sub command\n\nUsage:\n    $ <program> sub2\n\n"
}
...
func (CLI_Sub3) DESC_Simple() string {
	return "3 - this is a sub command\n\nUsage:\n    $ <program> sub3 [<option>|<argument>]... [-- [<argument>]...]\n\nOptions:\n    -option-a, -option-b, -option-c, -option-d, -option-e\n\nArguments:\n    <arg_a> <arg_b> <arg_c> <arg_d> <arg_e> <arg_v>...\n\nSubcommands:\n    suba, subb, subc, subd\n\n"
}
func (CLI_Sub3) DESC_Detail() string {
...
func (CLI_Sub3Suba) DESC_Simple() string {
	return "\nUsage:\n    $ <program> sub3 suba [<argument>]... [-- [<argument>]...]\n\nArguments:\n    <arg_v>...\n\n"
}
func (CLI_Sub3Suba) DESC_Detail() string {
	return "\nUsage:\n    $ <program> sub3 suba [<argument>]... [-- [<argument>]...]\n\n\nArguments:\n    [0:] [<arg_v:boolean>]...\n\n"
}
...
func (CLI_Sub3Subb) DESC_Simple() string {
	return "\nUsage:\n    $ <program> sub3 subb [<argument>]... [-- [<argument>]...]\n\nArguments:\n    <arg_v>...\n\n"
}
func (CLI_Sub3Subb) DESC_Detail() string {
	return "\nUsage:\n    $ <program> sub3 subb [<argument>]... [-- [<argument>]...]\n\n\nArguments:\n    [0:] [<arg_v:integer>]...\n\n"
}
...
func (CLI_Sub3Subc) DESC_Simple() string {
	return "\nUsage:\n    $ <program> sub3 subc [<argument>]... [-- [<argument>]...]\n\nArguments:\n    <arg_v>...\n\n"
}
func (CLI_Sub3Subc) DESC_Detail() string {
	return "\nUsage:\n    $ <program> sub3 subc [<argument>]... [-- [<argument>]...]\n\n\nArguments:\n    [0:] [<arg_v:float>]...\n\n"
}
...
func (CLI_Sub3Subd) DESC_Simple() string {
	return "\nUsage:\n    $ <program> sub3 subd [<argument>]... [-- [<argument>]...]\n\nArguments:\n    <arg_v>...\n\n"
}
func (CLI_Sub3Subd) DESC_Detail() string {
	return "\nUsage:\n    $ <program> sub3 subd [<argument>]... [-- [<argument>]...]\n\n\nArguments:\n    [0:] [<arg_v:string>]...\n\n"
}
