...
func NewCLI() CLI {
	...
	cli.Sub_Sub1.Func = cliautor_golang.NewDefaultFunc[CLI_Sub1_Input]()

	cli.Sub_Sub2.Func = cliautor_golang.NewDefaultFunc[CLI_Sub2_Input]()

	cli.Sub_Sub3.Func = cliautor_golang.NewDefaultFunc[CLI_Sub3_Input]()

	cli.Sub_Sub3.Sub_Subx.Func = cliautor_golang.NewDefaultFunc[CLI_Sub3Subx_Input]()

	cli.Sub_Sub3.Sub_Suby.Func = cliautor_golang.NewDefaultFunc[CLI_Sub3Suby_Input]()
