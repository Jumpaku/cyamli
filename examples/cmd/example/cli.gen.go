// Code generated by cyamli v0.0.9, DO NOT EDIT.
package main
...
func Run(cli CLI, args []string) error {
	...
	case "sub3 subx":
		...
		funcMethod := cli.Sub3.Subx.FUNC
		if funcMethod == nil {
			return fmt.Errorf("%q is unsupported: cli.Sub3.Subx.FUNC not assigned", "sub3 subx")
		}
		err := cyamli_golang.ResolveInput(cmd, restArgs, &input)
		return funcMethod(subcommand, input, err)
	...
	case "sub3 suby":
		...
		funcMethod := cli.Sub3.Suby.FUNC
		if funcMethod == nil {
			return fmt.Errorf("%q is unsupported: cli.Sub3.Suby.FUNC not assigned", "sub3 suby")
		}
		err := cyamli_golang.ResolveInput(cmd, restArgs, &input)
		return funcMethod(subcommand, input, err)
