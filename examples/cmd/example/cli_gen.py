...
FuncType_CLI_Sub3Subd = typing.Callable[[None,list[str],CLI_Sub3Subd_Input,Exception],None]
class CLI_Sub3Subd:
    
    FUNC: FuncType_CLI_Sub3Subd = None
...
FuncType_CLI_Sub3Subc = typing.Callable[[None,list[str],CLI_Sub3Subc_Input,Exception],None]
class CLI_Sub3Subc:
    
    FUNC: FuncType_CLI_Sub3Subc = None
...
FuncType_CLI_Sub3Subb = typing.Callable[[None,list[str],CLI_Sub3Subb_Input,Exception],None]
class CLI_Sub3Subb:
    
    FUNC: FuncType_CLI_Sub3Subb = None
...
FuncType_CLI_Sub3Suba = typing.Callable[[None,list[str],CLI_Sub3Suba_Input,Exception],None]
class CLI_Sub3Suba:
    
    FUNC: FuncType_CLI_Sub3Suba = None
...
FuncType_CLI_Sub3 = typing.Callable[[None,list[str],CLI_Sub3_Input,Exception],None]
class CLI_Sub3:
...
FuncType_CLI_Sub2 = typing.Callable[[None,list[str],CLI_Sub2_Input,Exception],None]
class CLI_Sub2:
    
    FUNC: FuncType_CLI_Sub2 = None
...
FuncType_CLI_Sub1 = typing.Callable[[None,list[str],CLI_Sub1_Input,Exception],None]
class CLI_Sub1:
    
    FUNC: FuncType_CLI_Sub1 = None
