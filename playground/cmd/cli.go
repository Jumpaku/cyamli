...
func Run(cli CLI, args []string) error {
	...
	case "sub1":
		...
		if err := cli.Sub_Sub1.Func(input); err != nil {
	...
	case "sub2":
		...
		if err := cli.Sub_Sub2.Func(input); err != nil {
	...
	case "sub3":
		...
		if err := cli.Sub_Sub3.Func(input); err != nil {
	...
	case "sub3 subx":
		...
		if err := cli.Sub_Sub3.Sub_Subx.Func(input); err != nil {
	...
	case "sub3 suby":
		...
		if err := cli.Sub_Sub3.Sub_Suby.Func(input); err != nil {
