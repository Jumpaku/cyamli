...
import { run, CLIHandler, Input, Input_Data, Input_Schema, Input_Tables } from './cli_gen.js';
...
class CLIHandlerMock implements CLIHandler {
    ...
    async run_Data(input: Input_Data): Promise<void> {
        this.gotInput = input;
    }
    
    async run_Schema(input: Input_Schema): Promise<void> {
        this.gotInput = input;
    }
    
    async run_Tables(input: Input_Tables): Promise<void> {
        this.gotInput = input;
    }
...
test.describe('run_Data', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Data;
            const want = tc.wantInput;
...
test.describe('run_Schema', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Schema;
            const want = tc.wantInput;
...
test.describe('run_Tables', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Tables;
            const want = tc.wantInput;
