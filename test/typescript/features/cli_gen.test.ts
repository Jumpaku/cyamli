...
import { run, CLIHandler, Input, Input_Sub1, Input_Sub1Sub2, Input_Sub1Sub2Sub3 } from './cli_gen.js';
...
class CLIHandlerMock implements CLIHandler {
    ...
    async run_Sub1(input: Input_Sub1): Promise<void> {
        this.gotInput = input;
    }
    
    async run_Sub1Sub2(input: Input_Sub1Sub2): Promise<void> {
        this.gotInput = input;
    }
    
    async run_Sub1Sub2Sub3(input: Input_Sub1Sub2Sub3): Promise<void> {
        this.gotInput = input;
    }
...
test.describe('run_Sub1', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Sub1;
            const want = tc.wantInput;
...
test.describe('run_Sub1Sub2', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Sub1Sub2;
            const want = tc.wantInput;
...
test.describe('run_Sub1Sub2Sub3', () => {
    ...
    testcases.forEach(tc => {
        test(tc.name, async () => {
            const mock = new CLIHandlerMock();
            await run(mock, tc.args);
            const got = mock.gotInput as Input_Sub1Sub2Sub3;
            const want = tc.wantInput;
