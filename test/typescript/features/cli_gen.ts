 ...
 * run_Sub1: function(Input_Sub1): Promise<void>,
 * run_Sub1Sub2: function(Input_Sub1Sub2): Promise<void>,
 * run_Sub1Sub2Sub3: function(Input_Sub1Sub2Sub3): Promise<void>,
 * })} CLIHandler
 */
/**
...
export interface CLIHandler {
  ...
  /**
   * Handles the run_Sub1 command.
   * @param { (Input_Sub1) } input - The input parameters for the command.
   * @returns {(Promise<void>)} A promise that resolves when the command is executed.
   */
  run_Sub1(input: Input_Sub1): Promise<void>;

  /**
   * Handles the run_Sub1Sub2 command.
   * @param { (Input_Sub1Sub2) } input - The input parameters for the command.
   * @returns {(Promise<void>)} A promise that resolves when the command is executed.
   */
  run_Sub1Sub2(input: Input_Sub1Sub2): Promise<void>;

  /**
   * Handles the run_Sub1Sub2Sub3 command.
   * @param { (Input_Sub1Sub2Sub3) } input - The input parameters for the command.
   * @returns {(Promise<void>)} A promise that resolves when the command is executed.
   */
  run_Sub1Sub2Sub3(input: Input_Sub1Sub2Sub3): Promise<void>;
...
export class Input {
   ...
   * @type { (boolean) }
   */
  public opt_NegationOption: boolean = false;

  /**
   * -option option.
   * @type { (number) }
   */
  public opt_Option: number = 123;

  /**
   * -propagation-option option.
   * @type { (string) }
   */
  public opt_PropagationOption: string = "";
   ...
   * @type { (boolean) }
   */
  public arg_FirstArg: boolean = false;

  /**
   * Argument of type number.
   * @type { (number) }
   */
  public arg_SecondArg: number = 0;

  /**
   * Argument of type string[].
   * @type { (string[]) }
   */
  public arg_ThirdArg: string[] = [];
